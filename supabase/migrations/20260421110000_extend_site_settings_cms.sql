...
set
  ...
  featured_headline = coalesce(featured_headline, 'A small, considered selection.'),
  ...
  trust_body = coalesce(trust_body, 'A small selection of partners we''ve shaped brand and digital work for.'),
  ...
  footer_cta_body = coalesce(footer_cta_body, 'We take on a small number of projects each quarter.'),
